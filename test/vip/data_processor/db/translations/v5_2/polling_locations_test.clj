(ns vip.data-processor.db.translations.v5-2.polling-locations-test
  (:require [clojure.test :refer :all]
            [vip.data-processor.test-helpers :refer :all]
            [vip.data-processor.db.postgres :as postgres]
            [vip.data-processor.db.translations.v5-2.polling-locations :as pl]
...
(deftest ^:postgres transformer-test
  (testing "polling_location.txt is loaded and transformed"
    (let [errors-chan (a/chan 100)
          ctx {:csv-source-file-paths (csv-inputs ["5-2/polling_location.txt"])
