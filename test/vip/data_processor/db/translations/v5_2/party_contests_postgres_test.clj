(ns vip.data-processor.db.translations.v5-2.party-contests-postgres-test
  (:require [clojure.test :refer :all]
            [vip.data-processor.validation.csv :as csv]
            [vip.data-processor.db.postgres :as postgres]
            [vip.data-processor.db.translations.v5-2.party-contests :as pc]
...
(deftest ^:postgres transformer-test
  (testing "party_contest.txt can be loaded and transformed"
    (let [errors-chan (a/chan 100)
          ctx {:csv-source-file-paths (csv-inputs ["5-2/party_contest.txt"])
