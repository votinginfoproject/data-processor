(ns vip.data-processor.db.translations.v5-2.election-administrations-postgres-test
  (:require [clojure.test :refer :all]
            [vip.data-processor.test-helpers :refer :all]
            [vip.data-processor.db.postgres :as postgres]
            [vip.data-processor.db.translations.v5-2.election-administrations :as ea]
...
(deftest ^:postgres transformer-test
  (let [errors-chan (a/chan 100)
        ctx {:csv-source-file-paths
             (csv-inputs ["5-2/contact_information.txt"
                          "5-2/department.txt"
                          "5-2/voter_service.txt"
                          "5-2/election_administration.txt"])
