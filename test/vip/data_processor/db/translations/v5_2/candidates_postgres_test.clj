(ns vip.data-processor.db.translations.v5-2.candidates-postgres-test
  (:require [clojure.test :refer :all]
            [vip.data-processor.test-helpers :refer :all]
            [vip.data-processor.db.postgres :as postgres]
            [vip.data-processor.db.translations.v5-2.candidates :as c]
...
(deftest ^:postgres candidates-transforms-test
  (testing "candidate.txt is loaded and transformed"
    (let [errors-chan (a/chan 100)
          ctx {:csv-source-file-paths (csv-inputs ["5-2/candidate.txt"])
