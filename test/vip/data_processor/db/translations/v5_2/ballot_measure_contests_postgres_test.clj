(ns vip.data-processor.db.translations.v5-2.ballot-measure-contests-postgres-test
  (:require [clojure.test :refer [deftest testing is are use-fixtures]]
            [korma.core :as korma]
            [vip.data-processor.db.postgres :as postgres]
            [vip.data-processor.db.translations.v5-2.ballot-measure-contests :as bmc]
...
(deftest ^:postgres transformer-test
  (testing "ballot_measure_contest.txt is loaded and transformed"
    (let [csv-file-paths (csv-inputs ["5-2/ballot_measure_contest.txt"])
