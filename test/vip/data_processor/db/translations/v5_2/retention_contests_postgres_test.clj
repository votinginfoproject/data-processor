(ns vip.data-processor.db.translations.v5-2.retention-contests-postgres-test
  (:require [clojure.test :refer :all]
            [vip.data-processor.validation.csv :as csv]
            [vip.data-processor.db.postgres :as postgres]
            [vip.data-processor.db.translations.v5-2.retention-contests :as rc]
...
(deftest ^:postgres transformer-test
  (testing "retention_contest.txt is loaded and transformed"
    (let [csv-files (csv-inputs ["5-2/retention_contest.txt"])
