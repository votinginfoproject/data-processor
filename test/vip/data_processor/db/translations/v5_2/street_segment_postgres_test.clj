(ns vip.data-processor.db.translations.v5-2.street-segment-postgres-test
  (:require [clojure.test :refer :all]
            [vip.data-processor.test-helpers :refer :all]
            [vip.data-processor.db.postgres :as postgres]
            [vip.data-processor.db.translations.v5-2.street-segments :as ss]
...
(deftest ^:postgres transformer-test
  (testing "street_segment.txt is loaded and transformed"
    (let [errors-chan (a/chan 100)
          ctx {:csv-source-file-paths (csv-inputs ["5-2/street_segment.txt"])
