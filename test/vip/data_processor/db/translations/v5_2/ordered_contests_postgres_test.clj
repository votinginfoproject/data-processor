(ns vip.data-processor.db.translations.v5-2.ordered-contests-postgres-test
  (:require [clojure.test :refer :all]
            [vip.data-processor.test-helpers :refer :all]
            [korma.core :as korma]
            [vip.data-processor.db.postgres :as postgres]
            [vip.data-processor.db.translations.v5-2.ordered-contests :as oc]
...
(deftest ^:postgres transformer-test
  (testing "ordered_contest.txt is loaded and transformed"
    (let [errors-chan (a/chan 100)
          ctx {:csv-source-file-paths (csv-inputs ["5-2/ordered_contest.txt"])
