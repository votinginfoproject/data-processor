(ns vip.data-processor.db.translations.v5-2.offices-postgres-test
  (:require [clojure.test :refer :all]
            [vip.data-processor.test-helpers :refer :all]
            [vip.data-processor.db.postgres :as postgres]
            [vip.data-processor.db.translations.v5-2.offices :as o]
  ...
  (testing "office.txt and contact_information.txt are loaded and transformed"
    (let [errors-chan (a/chan 100)
          ctx {:csv-source-file-paths
               (csv-inputs ["5-2/office.txt"
                            "5-2/contact_information.txt"])
