(ns vip.data-processor.db.translations.v5-2.candidate-contests-postgres-test
  (:require [clojure.test :refer :all]
            [vip.data-processor.db.postgres :as postgres]
            [vip.data-processor.db.translations.v5-2.candidate-contests :as cc]
...
(deftest ^:postgres contest->ltree-entries-test
  (testing "tests run the important function"
    (let [errors-chan (a/chan 100)
          ctx {:csv-source-file-paths (csv-inputs ["5-2/candidate_contest.txt"])
