...
begin
  ...
  execute 'create index ' || temp_table::regclass ||'_other_idx
          ...
          where simple_path = ''VipObject.Precinct.id''
             ...
             or simple_path = ''VipObject.Contest.id''
             or simple_path = ''VipObject.Contest.ElectoralDistrictId''
             or simple_path = ''VipObject.Contest.BallotSelectionIds''
             or simple_path = ''VipObject.BallotMeasureContest.id''
             or simple_path = ''VipObject.BallotMeasureContest.ElectoralDistrictId''
             or simple_path = ''VipObject.BallotMeasureContest.BallotSelectionIds''
             or simple_path = ''VipObject.BallotMeasureContest.BallotSelectionIds''
             or simple_path = ''VipObject.BallotMeasureContest.OfficeId''
             or simple_path = ''VipObject.CandidateContest.id''
             or simple_path = ''VipObject.CandidateContest.ElectoralDistrictId''
             or simple_path = ''VipObject.CandidateContest.BallotSelectionIds''
             or simple_path = ''VipObject.CandidateContest.OfficeIds''
             or simple_path = ''VipObject.CandidateContest.PrimaryPartyIds''
             or simple_path = ''VipObject.OrderedContest.id''
             or simple_path = ''VipObject.OrderedContest.ElectoralDistrictId''
             or simple_path = ''VipObject.OrderedContest.BallotSelectionIds''
             or simple_path = ''VipObject.OrderedContest.ContestId''
             or simple_path = ''VipObject.OrderedContest.OrderedBallotSelectionIds''
             or simple_path = ''VipObject.RetentionContest.id''
             or simple_path = ''VipObject.RetentionContest.ElectoralDistrictId''
             or simple_path = ''VipObject.RetentionContest.BallotSelectionIds''
             or simple_path = ''VipObject.RetentionContest.CandidateId''
             or simple_path = ''VipObject.RetentionContest.OfficeId''
             or simple_path = ''VipObject.PartyContest.id''
             or simple_path = ''VipObject.PartyContest.ElectoralDistrictId''
             or simple_path = ''VipObject.PartyContest.BallotSelectionIds''
