(ns vip.data-processor.validation.xml.v5
  (:require [clojure.data.xml :as xml]
            ...
            [vip.data-processor.validation.data-spec.v5-0 :as data-spec.v5-0]))
  ...
  (let [xml-file (first (:input ctx))]
    (with-open [reader (util/bom-safe-reader xml-file)]
      (->> reader
           ...
           (data-spec/coerce-rows (:columns data-spec.v5-0/street-segments))
           (postgres/bulk-import ctx postgres/v5-0-street-segments)))))
