(ns vip.data-processor.db.translations.v5-2.hours-open
  (:require [korma.core :as korma]
            [vip.data-processor.db.postgres :as postgres]
            [vip.data-processor.db.translations.util :as util]
            [vip.data-processor.db.translations.v5-2.schedules :as schedules]))

(defn row-fn [import-id]
  (let [schedules (korma/select (postgres/v5-2-tables :schedules)
