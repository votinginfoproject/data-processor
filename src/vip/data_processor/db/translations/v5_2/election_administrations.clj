(ns vip.data-processor.db.translations.v5-2.election-administrations
  (:require [korma.core :as korma]
            [vip.data-processor.db.postgres :as postgres]
            [vip.data-processor.db.translations.util :as util]
            [vip.data-processor.db.translations.v5-2.departments :as ds]
            [vip.data-processor.db.translations.v5-2.voter-services :as vs]))

(defn row-fn [import-id]
  (korma/select (postgres/v5-2-tables :election-administrations)
